  ...
  try {
    ...
    const payloadData = {
      ...
      metadata: {
        ...
        cancel_action: `${process.env.NEXT_PUBLIC_SITE_URL || 'http://localhost:3000'}/tickets`
      },
      callback_url: `${process.env.NEXT_PUBLIC_SITE_URL || 'http://localhost:3000'}/tickets?payment=success`,
