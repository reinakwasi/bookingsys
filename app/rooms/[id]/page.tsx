...
// Room data for metadata generation
const roomsMetadata = {
  1: {
    name: "Royal Suite",
    description: "Experience unparalleled luxury in our Royal Suite with ocean views, premium amenities, and 24/7 room service.",
    price: 500,
    image: "/room1.jpg"
  },
  2: {
    name: "Superior Room", 
    description: "Comfortable Superior Room with modern amenities, city views, and elegant furnishings for a perfect stay.",
    price: 250,
    image: "/room2.jpg"
  },
  3: {
    name: "Classic Room",
    description: "Cozy Classic Room with essential amenities and comfortable accommodations for a relaxing stay.",
    price: 150,
    image: "/room3.jpg"
  }
}
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  const roomId = parseInt(params.id) as keyof typeof roomsMetadata
  const room = roomsMetadata[roomId]
  
  if (!room) {
    return {
      title: "Room Not Found - Hotel 734",
      description: "The requested room could not be found."
    }
  }

  return {
    title: `${room.name} - Luxury Hotel Room | Hotel 734`,
    description: room.description,
    keywords: [`${room.name}`, "luxury hotel room", "Hotel 734", "premium accommodation", "hotel booking"],
    openGraph: {
      title: `${room.name} - Hotel 734`,
      description: room.description,
      url: `https://hotel734.com/rooms/${params.id}`,
      images: [
        {
          url: room.image,
          width: 1200,
          height: 630,
          alt: `${room.name} at Hotel 734`,
        }
      ],
    },
    twitter: {
    ...
    alternates: {
      canonical: `https://hotel734.com/rooms/${params.id}`,
    },
    other: {
      // Structured data for the room
