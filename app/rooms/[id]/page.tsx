...
const rooms = {
  1: {
    ...
    features: [
      ...
      { icon: Coffee, text: "Fridge" },
      { icon: Users, text: "Table & Chair" },
    ],
    longDescription: `Experience unparalleled luxury in our Royal Suite. This spacious room features a premium large bed 
    for ultimate comfort, luxury bathroom, and breathtaking ocean views. Enjoy the comfort of a private balcony, 
    and 24/7 room service. Perfect for those seeking the ultimate luxury experience with our most spacious bed.`,
  },
  2: {
    name: "Superior Room",
    type: "superior_room",
    ...
    longDescription: `Our Superior Room offers the perfect balance of comfort and value. Featuring a comfortable standard bed, 
    modern amenities, and a city view, this room is ideal for both business and leisure travelers. Enjoy the convenience 
    of a smart TV, modern bathroom, and complimentary breakfast.`,
  },
  3: {
    name: "Classic Room",
    type: "classic_room",
    ...
    longDescription: `The Classic Room provides a comfortable and affordable stay with all essential amenities. 
    Enjoy a peaceful garden view, a cozy classic bed, and a private bathroom. Perfect for budget-conscious travelers 
    who don't want to compromise on comfort, featuring our comfortable classic bed.`,
  },
}
