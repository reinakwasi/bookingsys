...
export function middleware(request: NextRequest) {
  ...
  const csp = [
    ...
    "frame-src 'self' https://checkout.paystack.com https://www.google.com https://maps.google.com https://maps.googleapis.com https://unified-pay.hubtel.com https://pay.hubtel.com",
    "object-src 'none'",
    "base-uri 'self'",
    "form-action 'self'",
  ...
  response.headers.set('Permissions-Policy', 
    'camera=(self), microphone=(), geolocation=(), payment=(self "https://checkout.paystack.com")'
  )
