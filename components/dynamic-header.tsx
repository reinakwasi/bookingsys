    ...
    >
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="text-center text-white max-w-4xl px-4">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-amber-400/20 backdrop-blur-sm text-amber-300 mb-6 animate-fade-in">
          ...
          <h1 className="text-5xl md:text-7xl font-bold mb-6 tracking-tight animate-slide-up">
            Welcome to <span className="text-amber-400 relative inline-block group">
              Hotel 734
              <span className="absolute -bottom-2 left-0 w-full h-1 bg-amber-400 transform origin-left scale-x-0 group-hover:scale-x-100 transition-transform duration-500" />
            </span>
          </h1>
          
          <p className="text-xl md:text-2xl mb-10 font-light tracking-wide text-slate-200 animate-slide-up-delay-1">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center animate-slide-up-delay-2">
            <a
              href="/booking"
              className="inline-flex items-center gap-2 bg-amber-400 text-slate-900 px-8 py-4 rounded-lg font-semibold hover:bg-amber-300 transition-all transform hover:scale-105 shadow-lg relative overflow-hidden group"
            >
            ...
            <a
              href="/rooms"
              className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm text-white border border-white/20 px-8 py-4 rounded-lg font-semibold hover:bg-white/20 transition-all transform hover:scale-105 relative overflow-hidden group"
            >
      ...
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 flex flex-col items-center gap-2 animate-fade-in-delay-3">
        <div className="text-white/80 text-sm animate-bounce">
          Scroll to explore
        </div>
